"""
🌱 Enhanced Environmental Visualization App with Sample Data
==========================================================

Interactive Streamlit app with pre-loaded sample data so you can see
the tabs and graphs immediately without having to track first.
"""
...
def main():
    ...
    ">
        ...
        <p style="margin: 10px 0 0 0; font-size: 1em; opacity: 0.8;">
            📊 Sample data pre-loaded - click the tabs below to see the graphs!
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    # Main content with tabs - NOW VISIBLE WITH SAMPLE DATA
